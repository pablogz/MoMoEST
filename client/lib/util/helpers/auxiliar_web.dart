...
class AuxiliarFunctions {
  ...
  static void downloadAnswerWeb(Answer answer, {String titlePage = 'CHEST'}) {
    ...
    anchor.download = 'CHEST-${DateTime.now().millisecondsSinceEpoch}';
    anchor.click();
  }
  ...
  static String getIdUser() {
    ...
    web.document.cookie = cookies.isEmpty
        ? "idUserChest=$newId"
        : "$cookies; idUserChest=$newId";
    return newId;
  }
