...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffe0b040),
      onTertiaryContainer: Color(0xff5d4400),
      ...
      tertiaryFixedDim: Color(0xfff1bf4e),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffffd785),
      onTertiary: Color(0xff322300),
      tertiaryContainer: Color(0xffe0b040),
      onTertiaryContainer: Color(0xff392800),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffedbc4b),
